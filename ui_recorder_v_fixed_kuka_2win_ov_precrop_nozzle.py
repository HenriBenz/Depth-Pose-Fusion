...
class RobotClient:
    ...
    def write_var(self, var: str, value) -> bool:
        ...
        Different py_openshowvar builds use slightly different signatures.
        We try a few common variants and return True on success.
        """
        ...
        # normalize: KUKA expects percent for $OV_PRO (typically 0..100)
        v_str = str(value)
        ...
        try:
            ...
            # Some variants accept a single combined command string
            try:
                w(f"{var} {v_str}")
                return True
            except Exception:
